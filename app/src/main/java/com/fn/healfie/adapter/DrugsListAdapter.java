...
public class DrugsListAdapter extends BaseAdapter {
    private List<DrugsBean> list = null;
    private Context context;
    private BaseOnClick back;

    public DrugsListAdapter(Context context, List<DrugsBean> list, BaseOnClick back) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == 0) {
            ...
            binding.tvTime.setText(list.get(position).getCnName());
