...
import com.fn.healfie.databinding.BindMobileActivityBinding;
...
public class BindMobileActivity extends BaseActivity implements BaseOnClick {

    BindMobileActivityBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.bind_mobile_activity, new LoginComponent(this));
    ...
    private void sendRegister() {
        ...
        connect.putData(MyUrl.BINDPHONE, map, new ConnectBack() {
            @Override
