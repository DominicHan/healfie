package com.fn.healfie.google.zxing.activity;
...
import com.fn.healfie.contact.AddContactInfoActivity;
import com.fn.healfie.contact.SearchNameActivity;
import com.fn.healfie.google.zxing.camera.CameraManager;
import com.fn.healfie.google.zxing.decoding.CaptureActivityHandler;
import com.fn.healfie.google.zxing.decoding.InactivityTimer;
import com.fn.healfie.google.zxing.decoding.RGBLuminanceSource;
import com.fn.healfie.google.zxing.util.BitmapUtil;
import com.fn.healfie.google.zxing.util.Constant;
import com.fn.healfie.google.zxing.view.ViewfinderView;
...
//            this.setResult(RESULT_OK, resultIntent);
    ...
    private void getData() {
        ...
        map.put("authorization", PrefeUtil.getString(this, PrefeKey.TOKEN, ""));
        map.put("keywords", scanResult);
        connect.getData(MyUrl.FRIENDSEARCH, map, new ConnectBack() {
            ...
            public void error(String json) {
                hideDialog();
                ToastUtil.errorToast(CaptureActivity.this, "-1022");
            }
        });
    }
...
//                    loge(bean.getItem().toString()+"");
                    if (bean.getResultCode().equals("200") && bean.getItem().getName()!=null) {
                        Intent intents = new Intent(CaptureActivity.this, AddContactInfoActivity.class);
                        ...
                        sendLogin(new ConnectLoginBack() {
                            ...
                            public void success(String json, String header) {
                                ...
                                if(registerBean.getResultCode().equals("200")){
                                    PrefeUtil.saveString(CaptureActivity.this, PrefeKey.TOKEN, registerBean.getItem().getAuthorization());
                        ...
                        ToastUtil.errorToast(CaptureActivity.this,"未能識別出二維碼");
                    }
                    break;
                case 2:
                    getData();
