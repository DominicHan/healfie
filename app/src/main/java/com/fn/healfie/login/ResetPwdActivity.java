...
import com.fn.healfie.databinding.ResetPwdActivityBinding;
...
public class ResetPwdActivity extends BaseActivity implements BaseOnClick {
    ResetPwdActivityBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.reset_pwd_activity, new LoginComponent(this));
